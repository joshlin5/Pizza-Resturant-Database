...
CREATE TABLE CONTAINS
	(PID			INT			NOT NULL,
	 Tname			INT			NOT NULL,
	 Extra			INT, --FIXME should this be INT?
	 CONSTRAINT CON_PK
...
CREATE TABLE BASE_PRICE
	(BID			INT			NOT NULL,
	 Size			VARCHAR(8)		NOT NULL, --FIXME should these be not null?
...
ALTER TABLE ADD CONSTRAINT PIZ_ORD_FK
	FOREIGN KEY(OID) REFERENCES ORDERS(OID);
ALTER TABLE ADD CONSTRAINT PIZ_BAS_FK
